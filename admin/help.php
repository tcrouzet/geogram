...
<ol>
    ...
    <li>Make <a href="https://t.me/GeoBikepacking" target="_blank">GeoBikepacking bot</a> a group administrator (open the group, click on the group name, select Edit Group, then select Administrators, and add GeoBikepacking).</li>
    <li>Define groups permissions like that.</li>

    <img src="/images/help-perms.jpg" />
